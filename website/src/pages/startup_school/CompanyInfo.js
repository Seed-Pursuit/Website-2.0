...
const CompanyInfo = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        // Create a unique key for the company data
        const newCompanyKey = user.sub;
        const companyData = {
            companyName,
            companyURL,
            companyDescription,
        ...
        const companyRef = ref(db, `profiles/${newCompanyKey}`);

        try {
            await set(companyRef, companyData);
            console.log('Company data has been successfully saved to the database.');
        } catch (error) {
    ...
    return (
        <div className='py-20 px-10 '>
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div>
                    <label htmlFor="companyName">Company Name<span className='text-red-300'>*</span></label>
                    <input
                        type="text"
                        id="companyName"
                        value={companyName}
                ...
                <div>
                    <label htmlFor="companyDescription">Describe your company in a few sentences<span className='text-red-300'>*</span></label>
                    <textarea
                ...
                <div>
                    <label htmlFor="companyCategory">Company Category<span className='text-red-300'>*</span></label>
                    <input
                        type="text"
                        id="companyCategory"
                ...
                <div>
                    <label htmlFor="startupStatus">Are you currently part-time or full-time on this startup?<span className='text-red-300'>*</span></label>
                    <select
                        id="startupStatus"
                        value={startupStatus}
                ...
                <div>
                    <label htmlFor="companyStage">Company Stage<span className='text-red-300'>*</span></label>
                    <select
                        id="companyStage"
                        value={companyStage}
                ...
                <div>
                    <label htmlFor="incorporated">Have you incorporated your company?<span className='text-red-300'>*</span></label>
                ...
                <div>
                    <button type="submit" className='p-3 bg-orange-300 md:rounded'>Submit</button>
                </div>
                <div>
                    <button type="submit" className='p-3 bg-red-300 md:rounded flex'>Leave Company <div className='p-1'><FiLogOut className='text-[20px]'/></div></button>
                </div>
                </div>
            </form>
        </div>
